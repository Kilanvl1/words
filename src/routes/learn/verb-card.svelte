...
<div class="w-full space-y-4">
	...
	{#if word.word.threeInARow}<div
			in:fly={{ y: 20, duration: 300 }}
			class="rounded-md bg-green-100 p-4 text-center text-green-800"
		>
			<p>You've got this word correct {word.word.consecutiveCorrect} times in a row!</p>
			<div class="flex justify-between">
				<form method="POST" action="?/setToMastered">
					<Input type="hidden" name="wordId" value={word.word.id}></Input>
